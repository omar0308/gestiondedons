...
import AjoutDon from './AjoutDon'
import AffectationDon from './AffectationDon'
import AjoutBenificiaire from './AjoutBenificiaire'
import AjoutFamille from './AjoutFamille'
...
export default function Ajout1() {
        ...
        <Box>
          <VStack >
            ...
            <Box width="300px" margin="20px auto">
              ...
              >
                <option value="componentA">Ajout d'un don</option>
                <option value="componentB">Affectation d'un don</option>
                <option value="componentC">Ajout d'un bénéficiaire</option>
                <option value="componentD">Ajout d'une famille</option>
              </Select>


            </Box>
            {selectedOption === 'componentA' && <AjoutDon />}
            {selectedOption === 'componentB' && <AffectationDon />}
            {selectedOption === 'componentC' && <AjoutBenificiaire />}
            {selectedOption === 'componentD' && <AjoutFamille />}
          </VStack>
        </Box>
      </Box>
    </Flex>
